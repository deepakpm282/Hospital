                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        >
                          <path
                            d="M14.25 2.25H13.5V0.75H12.75V2.25H5.25V0.75H4.5V2.25H3.75C2.8875 2.25 2.17998 2.8875 2.17998 3.75L2.25 16.5C2.25 17.3625 2.8875 18 3.75 18H14.25C15.1125 18 15.75 17.3625 15.75 16.5V3.75C15.75 2.8875 15.1125 2.25 14.25 2.25ZM14.25 16.5H3.75V7.5H14.25V16.5ZM5.25 4.5H6.75V6H5.25V4.5ZM8.25 4.5H9.75V6H8.25V4.5ZM11.25 4.5H12.75V6H11.25V4.5ZM5.25 7.5H6.75V9H5.25V7.5ZM8.25 7.5H9.75V9H8.25V7.5ZM11.25 7.5H12.75V9H11.25V7.5ZM5.25 10.5H6.75V12H5.25V10.5ZM8.25 10.5H9.75V12H8.25V10.5ZM11.25 10.5H12.75V12H11.25V10.5Z"
                            fill="#ffffff"
                          />
                        </svg>
              ...
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to={`/Lists/Deptlist?id=${hospital_id}`}
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      ...
                      >
                        ...
                        <li>
                          ...
                          <li>
                            <NavLink
                              to="/components/Hospital/AddDept"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
