...
import dep from '../../images/dept.jpg';
    ...
    <DefaultLayout>
        {deptData.map((brand, key) => (
          <div
                ...
                key={key}>
                <Breadcrumb pageName={brand.DName} />
                ...
                <div className="mx-auto  mt-12">
                  <div className="mr-4">
                    <div className="details-container  p-4 rounded">
                      <h2 className="text-xl text-black font-semibold mb-4">About</h2>
