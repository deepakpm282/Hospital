...
const SignUp: React.FC = () => {
  return (
        ...
        <div className="container rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="flex flex-wrap items-center">
            ...
            <div className="w-full xl:w-1/2 xl:border-l-2 border-stroke dark:border-strokedark">
              <div className="form-wrapper h-full p-2 sm:p-12.5 xl:p-10.5">
